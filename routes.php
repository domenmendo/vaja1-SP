...
if(isset($_SESSION["USER_ID"])){
  $controllers['users'] = array_merge($controllers['users'], ['edit', 'update', 'changePassword', 'change_pwd']);
  $controllers['auth'] = array_merge($controllers['auth'], ['logout']);
  $controllers['articles'] = array_merge($controllers['articles'], ['create'], ['list'], ['store'], ['edit'], ['update'], ['delete']); // TODO: 'list', 'store', 'edit', 'update', 'delete'
}
